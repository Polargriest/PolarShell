...
Item {
    ...
    Row {
        ...
        width: icon.width + spacing + titleText.contentWidth + 48

        Rectangle {
            width: icon.width + title.horizontalPadding*2
            height: icon.height + title.verticalPadding*2
        ...
        Rectangle {
            width: titleText.width + title.horizontalPadding*2
            height: titleText.height + title.verticalPadding*2
            color: Theme.colorWithAlpha(Theme.colors.bg, 0.6)
            border.color: Theme.colors.bg
            border.width: 2
            radius: 100
